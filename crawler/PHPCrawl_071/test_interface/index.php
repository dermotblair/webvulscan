...
if (isset($_POST["action"]) && $_POST["action"]=="start_crawling")
{
  ...
  include($cfg_phpcrawlClassDir."phpcrawlerutils.class.php"); 
...
<tr>
  ...
  <td width="233" valign="top">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>  
        <td>
          Follow redirects till content
          <a href="javascript: show_documentation('setfollowredirectstillcontent');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
        <td>
          <select name="val[setFollowRedirectsTillContent]" id="setFollowRedirectsTillContent">
          <?php
          // default value
          if (!isset($val["setFollowRedirectsTillContent"])) $val["setFollowRedirectsTillContent"]=1;
          ?>
          <option value="0" <?php if ($val["setFollowRedirectsTillContent"]==0) echo "selected"; ?>>No</option>
          <option value="1" <?php if ($val["setFollowRedirectsTillContent"]==1) echo "selected"; ?>>Yes</option>
          </select>
        </td>
      </tr>
      <tr>  
        <td>
          ...
          <a href="javascript: show_documentation('setcookiehandling');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
        <td>
      ...
      <tr>  
        <td>
          ...
          <a href="javascript: show_documentation('setaggressivelinkextraction');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
        <td>
...
<tr>
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td>
        Content-types to receive <a href="javascript: show_documentation('addreceivecontenttype');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
      </tr>
      <tr>
  ...
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td>Follow matches <a href="javascript: show_documentation('addfollowmatch');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;</td>
      </tr>
      <tr>
  ...
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td>
          Non follow matches <a href="javascript: show_documentation('addnonfollowmatch');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
      </tr>
      <tr>
...
<tr>
  ...
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td>
        Receive to tmp-file <a href="javascript: show_documentation('addreceivetotmpfilematch');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
      </tr>
      <tr>
  ...
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td>
        Receive to memory <a href="javascript: show_documentation('addreceivetomemorymatch');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
      </tr>
      <tr>
        <td><input type="text" name="val[addReceiveToMemoryMatch][0]" value="<?php if (isset($val["addReceiveToMemoryMatch"][0])) echo $val["addReceiveToMemoryMatch"][0]; ?>" size="30"></td>
      </tr>
      <tr>
        <td><input type="text" name="val[addReceiveToMemoryMatch][1]" value="<?php if (isset($val["addReceiveToMemoryMatch"][1])) echo $val["addReceiveToMemoryMatch"][1]; ?>" size="30"></td>
      </tr>
      <tr>
        <td><input type="text" name="val[addReceiveToMemoryMatch][2]" value="<?php if (isset($val["addReceiveToMemoryMatch"][2])) echo $val["addReceiveToMemoryMatch"][2]; ?>" size="30"></td>
      </tr>
    </table>
  </td>
</tr>
...
<tr>
  ...
  <td>
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="3">
        Tags to extract links from <a href="javascript: show_documentation('addlinkextractiontags');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;
        </td>
      </tr>
      <tr>
...
<tr>
  <td colspan="3">
    TMP-file to use <a href="javascript: show_documentation('settmpfile');"><img src="info.gif" align="absbottom" border="0"></a>&nbsp;<br>
    <input type="text" name="val[setTmpFile]" value="<?php if (isset($val["setTmpFile"])) echo $val["setTmpFile"]; ?>" size="50" style="width:400px">
    <br><br>
